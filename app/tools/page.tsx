...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.mailmark.dev/tools",
    // The same page as Markdown, for agents that read it that way.
    types: { "text/markdown": "https://www.mailmark.dev/tools.md" },
  },
...
const tools = [
  ...
  },
  {
    ...
    description:
      "Validate your email list before sending. Check for invalid addresses, disposable emails, missing MX records, and risky contacts.",
    href: "/tools/email-list-validator",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
