...
const faqs = [
  {
    question: "What is DevMail?",
    answer:
      "DevMail is an all-in-one email hosting and campaign platform for custom domains. You connect your own domain, create as many mailboxes as you need, and manage everything — from day-to-day email to mass outreach campaigns — in a single dashboard.",
  },
  {
    question: "Can I use my own custom domain?",
    answer:
      "Yes. DevMail is built around custom domains. You add your domain, configure the required DNS records (we provide step-by-step instructions), and your mailboxes go live in minutes. You can add multiple domains on paid plans.",
  },
  {
    question: "How many mailboxes can I create?",
    answer:
      "The Starter (free) plan supports up to 3 mailboxes on a single domain. The Pro plan gives you unlimited mailboxes across 5 domains, and the Business plan lifts all limits so your whole organization can be on DevMail.",
  },
  {
    question: "Does DevMail support email campaigns?",
    answer:
  ...
  {
    question: "What email clients or apps can I use with DevMail?",
    answer:
      "You can use the built-in DevMail web UI — which works in any modern browser. We also support IMAP and SMTP access, so you can connect your DevMail mailboxes to any standard email client such as Apple Mail, Thunderbird, or Outlook.",
  },
];
