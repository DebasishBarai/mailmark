...
import { X_URL } from "../../lib/site/social";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-100 pt-8 dark:border-gray-700 md:flex-row">
          ...
          <div className="flex gap-6">
            {/* <Link href={`${process.env.NEXT_PUBLIC_X_URL}`} ...> rendered
                href="undefined" wherever the variable was unset. X_URL keeps
                the variable as the override and falls back to the account. */}
            <Link href={X_URL} target="_blank" rel="noopener noreferrer" className="text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300" aria-label="Twitter">
