const gridFeatures = [
  ...
  },
  {
    ...
    description: "Multi-stage sequences that send automatically based on recipient behavior.",
  },
  {
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    title: "Analytics",
    description: "Real-time tracking for opens, clicks, replies, and bounces per campaign.",
  },
  {
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
