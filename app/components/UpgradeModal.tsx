...
const plans = [
  {
    ...
    name: "Starter",
    price: "$10",
    features: ["1,000 emails / month", "1 domain", "3 mailboxes", "Email campaigns"],
  },
  {
    key: "pro" as const,
    name: "Pro",
    price: "$25",
    features: ["25,000 emails / month", "5 domains", "Unlimited mailboxes", "Campaign analytics"],
    highlighted: true,
  },
  {
    ...
    name: "Business",
    price: "$75",
    features: ["100,000 emails / month", "Unlimited domains", "Campaign analytics", "Dedicated support"],
  },
];
