...
const categoryColors: Record<string, string> = {
  ...
  Campaigns: "bg-emerald-100 text-emerald-700",
...
export default function BlogPage() {
  ...
  return (
    <main>
      ...
      {/* Categories */}
      <section className="border-b border-gray-100 bg-white px-6">
      ...
      <section className="bg-white px-6 py-16">
        <div className="mx-auto max-w-7xl">
          {/* Featured post */}
          <div className="mb-14 overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-br from-violet-50 to-white transition-shadow hover:shadow-lg">
            <div className="p-8 sm:p-12">
              ...
              <p className="mt-3 max-w-2xl text-gray-600">{featuredPost.excerpt}</p>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {rest.map((post) => (
              <article
                key={post.title}
                className="flex flex-col rounded-2xl border border-gray-100 bg-white p-6 transition-all hover:border-violet-200 hover:shadow-md"
              >
                <span
