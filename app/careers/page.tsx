    ...
    <main className="bg-white dark:bg-gray-900">
      ...
      <section className="bg-white px-6 py-16 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl">
          <h2 className="text-center text-2xl font-bold text-gray-900 dark:text-white">Why DevMail</h2>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 rounded-2xl border border-dashed border-gray-200 p-8 text-center dark:border-gray-600">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <a href="mailto:jobs@devmail.app" className="text-violet-600 hover:underline dark:text-violet-400">
                jobs@devmail.app
              </a>
              .
            </p>
