...
export const metadata: Metadata = {
  title: "Careers - DevMail",
  description:
    "Join the DevMail team. We're a remote-first company building the future of professional email hosting and campaigns.",
};
...
const openings = [
  {
    ...
    type: "Full-time",
    description:
      "Help us build and scale the core DevMail platform — Next.js frontend, Convex backend, AWS email infrastructure. You'll own features end-to-end.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Create high-quality content — blog posts, docs, email guides — that drives organic growth and helps users get the most from DevMail.",
  },
];
    ...
    <main>
      ...
      <section className="bg-white px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <h2 className="text-center text-2xl font-bold text-gray-900">Why DevMail</h2>
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {perks.map((perk) => (
              ...
              >
                <p className="font-semibold text-gray-900">{perk.label}</p>
                <p className="mt-1.5 text-sm leading-relaxed text-gray-600">{perk.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 space-y-4">
            {openings.map((job) => (
              <div
                key={job.title}
                className="rounded-2xl border border-gray-100 bg-white p-6 transition-all hover:border-violet-200 hover:shadow-md"
              >
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <a
                    href="/contact"
                    className="shrink-0 rounded-full border border-violet-600 px-5 py-2 text-sm font-semibold text-violet-700 transition-colors hover:bg-violet-50"
                  >
                    Apply
                  </a>
                </div>
          ...
          <div className="mt-10 rounded-2xl border border-dashed border-gray-200 p-8 text-center">
            <p className="font-medium text-gray-700">Don&apos;t see a perfect fit?</p>
            <p className="mt-1 text-sm text-gray-500">
              We&apos;re always interested in exceptional people. Send us a note at{" "}
              <a href="mailto:jobs@devmail.app" className="text-violet-600 hover:underline">
                jobs@devmail.app
              </a>
              .
            </p>
