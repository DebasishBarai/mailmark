...
export const metadata: Metadata = {
  title: "Privacy Policy - RemindMe",
  description: "RemindMe Privacy Policy — how we collect, use, and protect your data.",
};
...
**Email data:** metadata and content of emails sent through or received by RemindMe (subject lines, sender/recipient addresses, timestamps). We process email content only to deliver the service and do not use it for advertising.
...
- Provide, operate, and improve the RemindMe platform.
...
**Legal compliance:** We may disclose data when required by law, court order, or governmental authority, or to protect the rights, property, and safety of RemindMe, our users, and the public.

**Business transfers:** If RemindMe is acquired or merges with another company, your data may be transferred as part of that transaction. We will notify you before your data is subject to a different Privacy Policy.
...
You can request earlier deletion of specific data by contacting privacy@remindme.me.`,
  },
  {
    title: "6. Security",
...
No method of transmission or storage is 100% secure. If you discover a security vulnerability, please report it to security@remindme.me.`,
  },
  {
    title: "7. Your rights",
...
To exercise any of these rights, email privacy@remindme.me. We will respond within 30 days.

**EEA/UK residents:** RemindMe processes data under GDPR. Our legal bases include contract performance, legitimate interests, and consent.
...
**California residents:** Under CCPA, you have additional rights including the right to know what data is sold or shared (we do not sell personal data).`,
  },
  {
    ...
    content: `RemindMe is not directed at children under 16. We do not knowingly collect personal data from anyone under 16. If you believe a child has provided us with personal information, contact us at privacy@remindme.me and we will delete it promptly.`,
  },
  {
      ...
      <section className="bg-gradient-to-b from-violet-50 to-white px-6 py-20 dark:from-violet-950/30 dark:to-gray-900">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-300">
            RemindMe (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) is committed to protecting your privacy.
