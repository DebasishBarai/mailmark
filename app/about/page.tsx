...
export const metadata: Metadata = {
  ...
  description:
    "Learn about RemindMe's mission to make professional email hosting and campaigns accessible to every business.",
};
...
const values = [
  ...
  },
  {
    ...
    description:
      "Whether you're a solo founder or a 50-person team, RemindMe scales with you. Shared inboxes, permissions, and collaboration baked in from day one.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <section className="bg-gradient-to-b from-violet-50 to-white px-6 py-24 dark:from-violet-950/30 dark:to-gray-900">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            We built RemindMe because we were tired of paying three different
      ...
      <section className="bg-white px-6 py-20 dark:bg-gray-900">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 space-y-5 text-gray-600 leading-relaxed dark:text-gray-300">
            <p>
              RemindMe started in 2024 when our founders — a team of engineers
            ...
            <p>
              We launched RemindMe&apos;s public beta in late 2025. Today,
              thousands of startups, agencies, and small teams use RemindMe to
