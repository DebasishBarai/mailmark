...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.mailmark.dev/guides/dns-setup",
    // The same page as Markdown, for agents that read it that way.
    types: { "text/markdown": "https://www.mailmark.dev/guides/dns-setup.md" },
  },
        ...
        <div className="mx-auto max-w-3xl">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    ...
                    <td className="px-4 py-3 font-mono text-xs dark:text-gray-300">inbound.mailmark.dev</td>
                  ...
                  <tr>
                    <td className="px-4 py-3 font-mono text-violet-700 dark:text-violet-400">MX</td>
                    <td className="px-4 py-3 font-mono dark:text-gray-300">@</td>
                    <td className="px-4 py-3 font-mono text-xs dark:text-gray-300">inbound-alt.mailmark.dev</td>
          ...
          <div className="mb-10">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="px-4 py-3 font-mono dark:text-gray-300">@</td>
                    <td className="px-4 py-3 font-mono text-xs dark:text-gray-300">v=spf1 include:spf.mailmark.dev ~all</td>
                    <td className="px-4 py-3 dark:text-gray-300">3600</td>
                  </tr>
                </tbody>
              </table>
            ...
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">
              <strong>Note:</strong> If you already have an SPF record, add <code className="rounded bg-gray-100 px-1 text-violet-700 dark:bg-gray-800 dark:text-violet-400">include:spf.mailmark.dev</code> to it rather than creating a second TXT record. Domains can only have one SPF record.
            </p>
          </div>
