...
export const metadata: Metadata = {
  title: "Email Deliverability Guide - DevMail",
  description:
      ...
      <section className="bg-gradient-to-b from-violet-50 to-white px-6 py-20">
        <div className="mx-auto max-w-3xl">
          <div className="flex items-center gap-2 text-sm text-violet-600">
            ...
            <span>/</span>
            <span className="text-gray-500">Email Deliverability</span>
          </div>
      ...
      <section className="bg-white px-6 py-12">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 rounded-2xl border border-gray-100 bg-gray-50 p-6">
            <h2 className="font-semibold text-gray-900">Healthy benchmarks</h2>
          ...
          {/* Summary */}
          <div className="mt-14 rounded-2xl border border-violet-100 bg-violet-50 p-6">
            <h3 className="font-semibold text-violet-900">Quick summary</h3>
            <p className="mt-2 text-sm leading-relaxed text-violet-800">
              ...
              and content quality). DevMail handles the technical infrastructure — the
              rest is up to you.
            </p>
          </div>
          ...
          <div className="mt-12 border-t border-gray-100 pt-10">
            <h3 className="font-semibold text-gray-900">Related guides</h3>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <Link href="/guides/dns-setup" className="flex items-center justify-between rounded-xl border border-gray-100 p-4 transition-all hover:border-violet-200 hover:shadow-sm">
                <span className="text-sm font-medium text-gray-700">DNS Setup Guide</span>
              ...
              <Link href="/docs" className="flex items-center justify-between rounded-xl border border-gray-100 p-4 transition-all hover:border-violet-200 hover:shadow-sm">
                <span className="text-sm font-medium text-gray-700">Campaign best practices</span>
                <svg className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>
              </Link>
