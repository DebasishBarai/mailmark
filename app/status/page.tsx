...
const components: { name: string; description: string; status: Status }[] = [
  ...
  { name: "Web Dashboard", description: "Dashboard UI at app.mailmark.dev", status: "operational" },
  { name: "API", description: "REST API at api.mailmark.dev", status: "operational" },
