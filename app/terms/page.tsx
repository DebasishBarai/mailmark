...
export const metadata: Metadata = {
  title: "Terms of Service - DevMail",
  description: "DevMail Terms of Service — the rules and guidelines for using our platform.",
};

const sections = [
  {
    title: "1. Acceptance of terms",
    content: `By accessing or using DevMail ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the Service.
...
These Terms apply to all users, including free and paid account holders. We may update these Terms at any time. Continued use of the Service after changes are posted constitutes acceptance.`,
  },
  {
    ...
    content: `DevMail provides email hosting, mailbox management, and email campaign tools. We allow you to connect your own domain, create mailboxes, and send and receive email via our infrastructure (powered by AWS SES and related services).
...
**Account security:** You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. Notify us immediately at support@devmail.app if you suspect unauthorized access.
...
**Failed payments:** If payment fails, we will attempt to charge again. After 7 days of failed payment, your account may be downgraded to the free plan and data may be at risk.`,
  },
  {
    ...
    content: `**DevMail IP:** The Service, including all software, design, and content, is owned by DevMail and protected by copyright and other intellectual property laws. You may not copy, modify, or distribute any part of the Service without our written permission.
...
We do not warrant that the Service will be uninterrupted, error-free, or completely secure. Email delivery is dependent on factors outside our control, including recipient server configurations.`,
  },
  {
    ...
    content: `To the maximum extent permitted by applicable law, DevMail and its officers, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or goodwill, arising out of or related to your use of the Service.
...
Any disputes arising from these Terms or the Service shall first be resolved through good-faith negotiation. If negotiation fails, disputes shall be resolved through binding arbitration under the rules of JAMS. Class action lawsuits are waived.`,
  ...
  {
    title: "13. Contact",
    content: `For questions about these Terms, contact us at legal@devmail.app or by mail at:
