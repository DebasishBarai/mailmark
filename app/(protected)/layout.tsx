...
const sidebarLinks = [
  ...
  {
    label: "Contacts",
    // Route is /audience, not /contacts: the public "contact the team" page
    // already owns /contact, and two routes one character apart is a trap for
    // whoever edits this next. The user facing label stays "Contacts" so it
    // matches the allowance named on the pricing and billing pages.
    href: "/audience",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
