    ...
    <div className="p-8">
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <p className="mt-2 text-3xl font-bold text-gray-900">
            {isLoading ? (
              <span className="inline-block h-8 w-8 animate-pulse rounded bg-gray-200" />
            ) : (
              domainCount
            )}
          </p>
          <span className="mt-2 inline-block rounded-full bg-violet-50 px-2 py-0.5 text-xs font-medium text-violet-700">
            View all
          </span>
        </Link>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white">
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
          <h2 className="text-base font-semibold text-gray-900">Your Domains</h2>
          <Link href="/domains" className="text-sm font-medium text-violet-600 hover:text-violet-700">
            Manage
          </Link>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="px-6 py-12 text-center">
            ...
            <p className="mt-4 text-sm font-medium text-gray-900">No domains yet</p>
            <p className="mt-1 text-sm text-gray-500">
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
            <h2 className="text-lg font-bold text-gray-900">Add a Domain</h2>
            <p className="mt-1 text-sm text-gray-500">
